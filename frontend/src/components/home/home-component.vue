<template>
  <div class="home-page" role="main" aria-label="Page d'accueil">
    <!-- Greeting -->
    ...
    <section v-if="isPatient" class="appointment-card" aria-label="Prochain rendez-vous">
      <header class="appointment-header">
        <h3 class="appointment-label" tabindex="0">
      ...
      >
        <h3 class="checklist-header" id="checklist-title">Tâches à faire avant le rendez-vous :</h3>
    ...
    >
      <header class="section-header">
        <h3 tabindex="0">Rendez-vous à venir</h3>
